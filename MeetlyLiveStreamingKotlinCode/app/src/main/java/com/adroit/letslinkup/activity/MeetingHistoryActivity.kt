...
import com.adroit.letslinkup.adapteritem.MeetingHistoryItem
import com.adroit.letslinkup.databinding.ActivityMeetingHistoryBinding
...
class MeetingHistoryActivity : AppCompatActivity() {
    ...
    //    setupToolbar()
      ...
      //  setupObservables()
       ...
       // if (LetsLinkUp.isAdEnabled) setupBannerAd() else binding.adViewContainer.makeGone()
    }
   ...
   /* override fun onSaveInstanceState(_outState: Bundle) {
    ...
    override fun onPause() {
        if (LetsLinkUp.isAdEnabled) adView.pause()
        super.onPause()
    }

    override fun onResume() {
        if (LetsLinkUp.isAdEnabled) adView.resume()
        super.onResume()
    }

    override fun onDestroy() {
        if (LetsLinkUp.isAdEnabled) adView.destroy()
        super.onDestroy()
    }
