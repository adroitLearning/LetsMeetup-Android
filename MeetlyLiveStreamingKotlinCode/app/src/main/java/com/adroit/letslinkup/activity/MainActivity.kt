...
import com.adroit.letslinkup.LetsLinkUp
import com.adroit.letslinkup.R
import com.adroit.letslinkup.databinding.ActivityMainBinding
import com.adroit.letslinkup.model.Meeting
import com.adroit.letslinkup.sharedpref.AppPref
import com.adroit.letslinkup.utils.MeetingUtils
...
class MainActivity : AppCompatActivity() {
  ...
  /*  private lateinit var createMeetingInterstitialAd: InterstitialAd
    ...
    private fun createMeeting(meetingCode: String) {
        ...
        viewModel.addMeetingToDb(Meeting(meetingCode,System.currentTimeMillis())) // Add meeting to db
    }
